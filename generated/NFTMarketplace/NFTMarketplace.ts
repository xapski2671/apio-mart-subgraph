...
export class CollectionFound extends ethereum.Event {
  get params(): CollectionFound__Params {
    return new CollectionFound__Params(this);
  }
}

export class CollectionFound__Params {
  _event: CollectionFound;

  constructor(event: CollectionFound) {
    this._event = event;
  }
...
export class NFTMarketplace__getCollectionResultValue0Struct extends ethereum.Tuple {
  get name(): string {
...
export class NFTMarketplace extends ethereum.SmartContract {
  ...
  getCollection(
    nftAddress_: Address
  ): NFTMarketplace__getCollectionResultValue0Struct {
    let result = super.call(
      "getCollection",
      "getCollection(address):((string,string,address))",
      [ethereum.Value.fromAddress(nftAddress_)]
    );

    return changetype<NFTMarketplace__getCollectionResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getCollection(
    nftAddress_: Address
  ): ethereum.CallResult<NFTMarketplace__getCollectionResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<NFTMarketplace__getCollectionResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getProceeds(seller_: Address): BigInt {
    let result = super.call("getProceeds", "getProceeds(address):(uint256)", [
      ethereum.Value.fromAddress(seller_)
    ]);

    return result[0].toBigInt();
  }

  try_getProceeds(seller_: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getProceeds",
